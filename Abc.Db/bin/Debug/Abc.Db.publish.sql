/*
Deployment script for AbcDatabase
...
GO
:setvar DatabaseName "AbcDatabase"
:setvar DefaultFilePrefix "AbcDatabase"
...
GO
PRINT N'Creating [dbo].[FK_Product_ProductType]...';
...
GO
PRINT N'Creating [dbo].[uspGetProductById]...';
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '93668b73-ff5d-4e1f-962a-13e546564ae5')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('93668b73-ff5d-4e1f-962a-13e546564ae5')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'e878036c-b1c8-405f-820e-1c327601b5b9')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('e878036c-b1c8-405f-820e-1c327601b5b9')
